  ...
  return (
    <Container className="pb-16 pt-20 text-center lg:pt-16">
      ...
      <div className="mt-10 flex justify-center gap-x-6">
        <Button href="#get-started-today">Contact us</Button>
        {/*<Button*/}
      ...
      <div className="mt-36 lg:mt-44">
        <p className="font-display text-lg font-semibold text-slate-900 font">
          Trusted by
        </p>
          <div className={'grid lg:flex lg:flex-row gap-16  mt-12 md:grid-cols-2 sm:grid-cols-1 mx-auto justify-center'}>
              {[
                  {
                      name: "Udyam Ventures",
