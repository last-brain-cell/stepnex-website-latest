...
export default function RolesSection() {
  const roles: Role[] = [
    {
      ...
      description:
        "Develop and maintain dynamic web applications using React.js while collaborating with cross-functional teams to enhance user experience and optimize performance.",
      skills: [
        "HTML5",
        "CSS3",
        "JavaScript",
    ...
    // },
    {
      ...
      description:
        "Assist in designing and refining user interfaces and experiences for web applications, collaborating with the team to create intuitive and engaging designs.",
    ...
    },
    {
      ...
      description:
        "Support the development and maintenance of web applications using React.js, collaborating with the team to enhance user experience and troubleshoot issues.",
      skills: [
        "HTML5",
        "CSS3",
        "JavaScript",
  ...
  return (
    <div className={"my-16"} id={"roles"}>
      <RolesHeading />
      <div
        className={"grid lg:grid-cols-3 gap-4 md:grid-cols-2 px-12 grid-cols-1"}
      >
        {roles.map((role) => {
